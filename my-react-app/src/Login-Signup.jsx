...
function Login_Signup() {
    ...
    const handleSignUpSubmit = async (event) => {
        ...
        // check if the signup captcha has been done.
        if (!signupCaptcha) {
        ...
        try {
        const response = await fetch('https://guardiansofth.maurice.webcup.hodi.host/backend/register', {  // replace URL with your actual backend URL
            method: 'POST',
            headers: {
    ...
    const handleSignInSubmit = async (event) => {
        ...
        // try to login.
        try {
        const response = await fetch('https://guardiansofth.maurice.webcup.hodi.host/backend/login', {  // Your login endpoint here
            method: 'POST',
